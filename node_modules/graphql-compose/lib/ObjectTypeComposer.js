...
class ObjectTypeComposer {
  ...
  getFieldExtensions(fieldName) {
    ...
    if ((0, _is.isFunction)(field)) {
      field = field();
    }

    if ((0, _is.isObject)(field) && !(0, _is.isFunction)(field) && !Array.isArray(field) && !isComposeOutputType(field) && !(field instanceof _graphql.GraphQLList || field instanceof _graphql.GraphQLNonNull)) {
  ...
  setFieldExtensions(fieldName, extensions) {
    ...
    if (!(0, _is.isFunction)(field) && ((0, _is.isString)(field) || Array.isArray(field) || field instanceof _graphql.GraphQLList || field instanceof _graphql.GraphQLNonNull || isComposeOutputType(field))) {
      field = {
        type: field
      };
