...
export class ObjectTypeComposer {
  ...
  getFieldExtensions(fieldName) {
    ...
    if (isObject(field) && !isFunction(field) && !Array.isArray(field) && !isComposeOutputType(field) && !(field instanceof GraphQLList || field instanceof GraphQLNonNull)) {
  ...
  setFieldExtensions(fieldName, extensions) {
    ...
    if (!isFunction(field) && (isString(field) || Array.isArray(field) || field instanceof GraphQLList || field instanceof GraphQLNonNull || isComposeOutputType(field))) {
      field = {
        type: field
      };
